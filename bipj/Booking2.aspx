...
<asp:Content ID="ContentHead" ContentPlaceHolderID="head" runat="server">
  <!-- Font Awesome for stars & filter icon -->
  <script src="https://kit.fontawesome.com/a076d05399.js" crossorigin="anonymous"></script>
  <style>
    /* ── WIZARD ── */
    .wizard { display: flex; justify-content: center; gap: 20px; margin: 30px 0; }
    .wizard .step { width: 40px; height: 40px; line-height: 40px; border-radius: 50%; background: #ccc; text-align: center; color: #fff; font-weight: bold; }
    .wizard .step.completed,
    .wizard .step.active { background: #5e4b8b; border: 3px solid #d3c8ff; }

    /* ── SEARCH & FILTER CONTROLS ── */
    .control-panel { display: flex; flex-direction: column; align-items: center; }
    .advisor-search { display: flex; gap: 10px; margin-bottom: 10px; }
    .advisor-search input { padding: 8px; width: 250px; border-radius: 6px; border: 1px solid #ccc; font-size: 14px; }
    .advisor-search .filter-btn { background: #5e4b8b; color: #fff; border: none; border-radius: 6px; padding: 8px 12px; cursor: pointer; font-size: 14px; }
    .filter-panel { background: #f9f9f9; border: 1px solid #ddd; border-radius: 8px; padding: 12px; margin-bottom: 20px; width: 80%; max-width: 600px; }
    .filter-item { margin-bottom: 10px; }
    .filter-item label { margin-right: 8px; font-weight: bold; }

    /* ── CARD GRID & CARDS (from ApproveAdvisor) ── */
    .card-grid {
      display: grid;
    ...
    .card-header {
      height: 140px; background: #5e4b8b;
    ...
    .card-body h4 {
      margin: 0 0 4px; color: #3b3350; font-size: 20px;
    }
    .card-body .category {
      font-size: 14px; color: #777; margin-bottom: 12px;
    }
    ...
    .card-body .specialties h5 {
      margin: 0 0 6px;
      font-size: 14px; color: #5e4b8b;
      text-transform: uppercase; letter-spacing: .5px;
    }
    .card-body .bio p {
      margin: 0; font-size: 14px; color: #555; line-height: 1.4;
    }
