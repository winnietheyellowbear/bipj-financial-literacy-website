...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  <!-- Bootstrap CSS needed for modal and styling -->
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="container-fluid mainpage-content">
    ...
    <div class="tools-header">
      ...
      <div class="action-group">
        <!-- Restart All Jars trigger: use plain button to reliably open modal -->
    ...
    <div class="section-card">
      ...
      <asp:Panel ID="pnlUpload" runat="server" CssClass="mb-3 d-flex flex-wrap gap-2 align-items-start">
        ...
        <asp:Button ID="btnParse" runat="server" Text="Upload & Preview" CssClass="btn btn-primary"
      ...
      <asp:Panel ID="pnlPreview" runat="server" Visible="false">
        ...
        <div class="row mb-3">
          <div class="col-md-6">
            ...
            <asp:DropDownList ID="ddlDefaultJar" runat="server" CssClass="form-select"
                              AutoPostBack="true" OnSelectedIndexChanged="ddlDefaultJar_SelectedIndexChanged" />
          </div>
        </div>
      ...
      <!-- Done / feedback -->
      <asp:Panel ID="pnlDone" runat="server" Visible="false" CssClass="alert alert-success mt-4">
  ...
  <div class="modal fade" id="confirmRestartModal" tabindex="-1" aria-labelledby="confirmRestartLabel"
       aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          This will reset all jars (balances, snapshots, progress) for your account. This action cannot be undone.
          Proceed?
        </div>
        <div class="modal-footer">
          <asp:Button ID="btnConfirmRestart" runat="server" CssClass="btn btn-danger"
                      Text="Yes, Restart All" OnClick="btnRestartAllJars_Click" CausesValidation="false" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="scripts" runat="server">
  ...
  <script>
    // disable confirm button after click to prevent double submit
    document.addEventListener('DOMContentLoaded', function () {
      const confirmBtn = document.getElementById('<%= btnConfirmRestart.ClientID %>');
        if (confirmBtn) {
            confirmBtn.addEventListener('click', function () {
                confirmBtn.disabled = true;
                confirmBtn.innerText = 'Restarting...';
            });
        }
    });
  </script>
